...
const HomePage = () => {
  return (
    <div className="bg-[#0F1A1F] text-[#14FFEC] min-h-screen p-8 w-full">
      <header className="text-left mb-8 flex items-center">
        <div>
          ...
          Discover the future of education with our innovative and engaging cryptocurrency solutions!
          </p>
        </div>
        <img
          src={bitimg}
      ...
      <section className="text-center mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-[#081014] p-6 rounded-lg transform transition duration-300 hover:scale-105 hover:bg-[#19333f] text-[#e0f7fa]">
...
const AboutUs = () => {
  ...
  return (
    <div className="bg-[#0F1A1F] text-[#14FFEC] min-h-screen p-8">
      <header className="text-center mb-8">
        <h1 className="text-xl font-bold text-[#14FFEC]">About Us</h1>
      </header>
      <div className="bg-[#0F1A1F] text-[#14FFEC] min-h-screen p-8 flex flex-col items-center">
...
const Footer = () => {
  return (
    <footer className="bg-[#0F1A1F] text-[#14FFEC] py-4 text-center">
      ...
      <p className="text-[14px] mt-2">
        © {new Date().getFullYear()} TeachX. All Rights Reserved.
      </p>
    </footer>
  );
};
